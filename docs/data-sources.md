...
| Nigeria subnational administrative boundaries (admin 0–3) | [HDX `cod-ab-nga`](https://data.humdata.org/dataset/cod-ab-nga) | SHP, 10 layers, EPSG:4326 | LGA (774) and state (37) | **Downloaded 13 Sep 2026** |
| Nigeria subnational population, 2020 projection | [HDX `cod-ps-nga`](https://data.humdata.org/dataset/cod-ps-nga) | XLSX, sheet `nga_admpop_adm2_2020` | LGA (773 of 774) | **Downloaded 13 Sep 2026** |
...
**Why the OCHA Common Operational Dataset was chosen over GRID3.** It carries
admin-2 **PCODEs**, and the NMSP intervention table has no codes at all — only
